			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown user user-menu"><a href="#"
					class="dropdown-toggle" data-toggle="dropdown"> <img
						src="${basePath}/img/user2-160x160.jpg"
		...
		<ul class="sidebar-menu">
			...
			<li class="treeview"><a href="#"> <i class="fa fa-cogs"></i>
				...
				<ul class="treeview-menu">
					...
					<li id="system-setting"><a href="${basePath}/role/findAll.do">
							<i class="fa fa-circle-o"></i> 角色管理
					</a></li>
					<li id="system-setting"><a href="${basePath}/permission/findAll.do">
			...
			<li class="treeview"><a href="#"> <i class="fa fa-cube"></i>
				...
				<ul class="treeview-menu">
					...
					<li id="system-setting"><a
						href="${basePath}/product/findAll.do">
							<i class="fa fa-circle-o"></i> 产品管理
					</a></li>
					<li id="system-setting"><a
						href="${basePath}/order/findAll.do?page=1&pageSize=3">
			...
			<section class="content">
				<div class="error-page">
					...
					<div class="error-content">
						...
						<p>
							登录失败 , 你可以 <a href="${basePath}/login.jsp">返回到登录页面</a>
							重新登录
						</p>
