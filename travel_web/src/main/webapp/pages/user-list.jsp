						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="新建" onclick="location.href='${basePath}/pages/user-add.jsp'">
									...
									<c:forEach items="${userList}" var="user">
										<tr>
											...
											<td class="text-center">
												<a href="${basePath}/user/findById.do?uid=${user.uid}" class="btn bg-olive btn-xs">详情</a>
												<a href="${basePath}/user/findUserByIdAndAllRole.do?uid=${user.uid}" class="btn bg-olive btn-xs">添加角色</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
