	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li><a
					href="${basePath}/role/findAll.do">角色管理</a></li>
						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="新建" onclick="location.href='${basePath}/pages/role-add.jsp'">
									...
									<c:forEach items="${roleList}" var="role">
										<tr>
											...
											<td class="text-center">
												<a href="${basePath}/role/findById.do?rid=${role.rid}" class="btn bg-olive btn-xs">详情</a>
												<a href="${basePath}/role/findRoleByIdAndAllPermission.do?rid=${role.rid}" class="btn bg-olive btn-xs">添加权限</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
