	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li><a
					href="${basePath}/permission/findAll.do">权限管理</a></li>
						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="新建" onclick="location.href='${basePath}/pages/permission-add.jsp'">
									...
									<c:forEach items="${permissionList}" var="permission">
										<tr>
											...
											<td class="text-center">
												<a href="${basePath}/permission/findById.do?pid=${permission.pid}" class="btn bg-olive btn-xs">详情</a>
												<a href="${basePath}/permission/findByid.do?pid=${permission.pid}" class="btn bg-olive btn-xs">添加权限</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
